...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '姚艺遥', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '如果找不到靠谱的中介，那么自己能不能成为中介🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://520hy.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '兼职, 测评,分享', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'linchenxi197@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://520hy.xyz', // 你的微博个人主页
  ...
  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://520hy.xyz', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项
